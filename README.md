...
Install NodeJS
run Node with Main.js as your entry point.
The app should now be viewable in browser, for local machines the default address in 127.0.0.1 on port 3000
...
* **Jose Daniel Avelares** - *Initial work* - [Dan-Avel](https://github.com/Dan-Avel)
